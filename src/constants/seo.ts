...
export const SITE_DESCRIPTION =
  "AI-powered resume analyzer that evaluates your CV, highlights weaknesses, optimizes keywords for ATS systems, and helps you land interviews faster.";
...
export const SEO_DEFAULT: Metadata = {
  ...
  keywords: ["nextjs", "react", "typescript", "web development", "frontend"],
